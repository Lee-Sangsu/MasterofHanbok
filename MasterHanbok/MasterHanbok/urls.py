...
from .views import UserRegisterAPIView, UserLoginAPIView, DeleteUserView, PushNotificationView, BidderRegistrationView, BidderLoginView
...
urlpatterns = [
    ...
    path('user/stores/sign-up/', BidderRegistrationView.as_view()),
    path('user/stores/sign-in/', BidderLoginView.as_view()),
